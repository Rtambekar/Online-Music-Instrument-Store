...
(2, 'Keyboard', 'no', 'piano.png'),
(3, 'synth', 'no', 'synth.png'),
(4, 'Electric Guitar', 'yes', 'electric-guitar.png'),
(5, 'Guitar', 'yes', 'guitar.png');
...
(2, 'Yamaha', 'no', 'yamahalogo.png'),
(3, 'Roland', 'no', 'rolandlogo.png'),
(4, 'Gibson', 'no', 'gibsonlogo.png'),
(5, 'Fender', 'no', 'fenderlogo.png'),
(7, 'Korg', 'no', 'korglogo.png'),
(8, 'Casio', 'no', 'casiologo.png');
...
(4, 'Pedals and Processors', 'no', ''),
(5, 'Guitar Amplifiers', 'no', ''),
(6, 'Percussions', 'no', ''),
(7, 'Plugins', 'yes', ''),
(8, 'Samples', 'yes', ''),
(9, 'Headphones', 'no', '');
...
INSERT INTO `sound` (`id`, `type`, `name`,`filepath`) VALUES
(1, piano,;p ,"E/tunes/;.wav");
(2, piano, ap,);
(3, piano,dp, );
(4, piano,ep, );
(5, piano,fp, );
...
(16, piano,wp, );
(17, piano,yp, );
INSERT INTO `icity` (`cno`, `cname`,`sno`) VALUES(11,'pune',101),(12,'MUmbai',101),(13,'Nashik',101),(14,'surat',102),(15,'badodara',102),(16,'indore',103),(17,'ratlam',103);